...
const UpdateConfirmationWizardItem = () => {
    return (
        <div className="w-full mx-auto mt-4 sm:mt-14">
            ...
            <div className="flex justify-center my-12">
                <svg xmlns="http://www.w3.org/2000/svg" width="393" height="264">
                    <defs>
            ...
            <div className="text-center mb-40">
                <p className="sm:text-xl">
                    Abbiamo ricevuto la tua richiesta di aggiornamento dati carta fedeltà.
                </p>
            </div>
        </div>
    );
};
export default UpdateConfirmationWizardItem;
