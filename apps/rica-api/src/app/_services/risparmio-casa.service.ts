...
export class RisparmioCasaService {
    ...
    private readonly logger = new Logger(RisparmioCasaService.name);

    constructor(
        private readonly httpService: HttpService
    ) { }

    createEmptyCard(registrationCountry: Country) {
    ...
    addDataToCard(details: { [key: string]: any } & { registrationCountry: Country }, cardNumber, updateFromStore) {
        let xml = '<?xml version="1.0" encoding="utf-8"?>';
        xml +=
            '<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">';
        xml += "<soap:Body>";
    ...
    verify(cardNumber: string, registrationCountry: Country) {
        let xml = '<?xml version="1.0" encoding="utf-8"?>';
        xml +=
            '<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">';
        xml += "<soap:Body>";
